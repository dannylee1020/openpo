OpenPO is published as a [Python package](https://pypi.org/project/openpo/) and can be installed using `pip`. Simplest way to start is running the following command.
